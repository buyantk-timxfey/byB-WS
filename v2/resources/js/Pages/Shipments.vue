...
const data = ref<Ship[]>([
    { id: 'ПОСТ-2026-0044', date: '01.07.2026', supplier: 'ООО Профиль', name: 'Кабель-канал', sum: 214000, paid: 0, status: 'Ожидает отправки', eta: '12.07.2026', problem: false, carrier: 'СДЭК', tracking: '', delivery: 6000, items: [{ name: 'Кабель-канал 40×40', qty: 200, price: 1040 }] },
    { id: 'ПОСТ-2026-0043', date: '28.06.2026', supplier: 'ИП Сидоров', name: 'Насосы Grundfos', sum: 96500, paid: 50000, status: 'В пути', eta: '10.07.2026', problem: false, carrier: 'Деловые линии', tracking: 'DL-882190', delivery: 4500, items: [{ name: 'Насос Grundfos UPS 25-40', qty: 5, price: 18400 }] },
    { id: 'ПОСТ-2026-0042', date: '20.06.2026', supplier: 'ИП Сидоров', name: 'Партия кабеля', sum: 184000, paid: 184000, status: 'Завершено', eta: '02.07.2026', problem: false, carrier: 'ПЭК', tracking: 'PEK-771203', delivery: 7000, items: [{ name: 'Кабель ВВГ 3×2.5', qty: 320, price: 553 }] },
    { id: 'ПОСТ-2026-0041', date: '15.06.2026', supplier: 'ИП Кузнецов', name: 'Автоматы ABB', sum: 142000, paid: 142000, status: 'Завершено', eta: '25.06.2026', problem: true, carrier: 'СДЭК', tracking: 'CDEK-5510', delivery: 3200, items: [{ name: 'Автомат ABB SH201 C16', qty: 100, price: 1388 }] },
    { id: 'ПОСТ-2026-0040', date: '12.06.2026', supplier: 'ООО Метком', name: 'Лотки металлические', sum: 78000, paid: 0, status: 'В пути', eta: '08.07.2026', problem: false, carrier: 'Байкал Сервис', tracking: 'BS-22019', delivery: 5400, items: [{ name: 'Лоток 100×50', qty: 60, price: 1210 }] },
]);
...
function create() {
    cur.value = { id: 'ПОСТ-2026-0045', date: '', supplier: '', name: '', sum: 0, paid: 0, status: 'Ожидает отправки', eta: '', problem: false, carrier: '', tracking: '', delivery: 0, items: [] };
    open.value = true;
}
</script>
    ...
    <AppShell>
        ...
        <Drawer :open="open" :title="cur?.id || 'Новое поступление'" :subtitle="cur?.supplier" @close="open = false">
            ...
            <template #footer>
                ...
                <button class="btn-ghost pressable">Оплатить</button>
